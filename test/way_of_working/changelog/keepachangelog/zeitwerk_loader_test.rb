    ...
    module Keepachangelog
      class ZeitwerkLoaderTest < Minitest::Test
        def setup
          ...
          namespace = WayOfWorking::Changelog
          @loader = Zeitwerk::Loader.new
          @loader.tag = "#{namespace.name}-keepachangelog.rb"
          @loader.inflector = Zeitwerk::GemInflector.new(@root.join('lib/way_of_working/changelog/keepachangelog.rb'))
